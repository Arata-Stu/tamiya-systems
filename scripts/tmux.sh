...
# --- 実行するコマンド群 ---
CMD_BASE="ros2 launch system_launch system.launch.xml localization:=false vslam:=false use_camera:=true use_lidar:=true use_ftg:=false  use_emergency:=false record:=false"  # 左ペインで実行するROS 2起動コマンド
