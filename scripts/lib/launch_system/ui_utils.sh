...
Examples:
  ...
  ${SCRIPT_NAME} production --set map_dir=/map/mybag/mycourse --set use_speed_controller=true
  ${SCRIPT_NAME} vslam_eval --set map_dir=/map/mybag/mycourse --set use_camera=false --set use_hd_map=true --set use_hd_map_section_localizer=true --set use_planning=true --set localize_on_startup=true --set planning_publish_local_path=false --set planning_publish_local_reference=false
